...
<body>
  <table style="margin-top: 5%;" width="800" border="1" align="center" bordercolor="#84C1EA" cellpadding="1" cellspacing="0">
    ...
    <tr style="background-color: white;">
      <td>
        <p>&nbsp;</p>
        <form action="delstudent.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            ...
            <tbody>
              <tr>
                <td colspan="2" bgcolor="#84C1EA">
                  <div align="center">
                    <font color="#FFFFFF">ลบข้อมูลนักเรียน</font>
                  </div>
                </td>
              </tr>
              <tr>
                <td width="221">ชื่อ-สุกล</td>
                <td width="203"><input name="std_name" type="text" id="std_name" value="<?php echo "$rs[std_name]"; ?>" readonly="readonly" />
              ...
              <tr>
                ...
                <td width="203"><textarea name="std_address" rows="2" readonly="readonly" id="std_address" value="<?php echo "$rs[std_address]"; ?> "><?php echo "$rs[std_address]"; ?></textarea></td>
              </tr>
              <tr>
                <td width="221">เบอร์โทร</td>
                <td width="203"><input name="std_tel" type="text" id="std_tel" value="<?php echo "$rs[std_tel]"; ?>" readonly="readonly"></td>
              </tr>
              <tr>
                <td width="221">รูป</td>
                <td width="203">
