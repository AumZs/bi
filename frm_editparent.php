...
<body>
  <table style="margin-top: 5%;" width="800" border="1" align="center" bordercolor="#84C1EA" cellpadding="1" cellspacing="0">
    ...
    <tr style="background-color: white;">
      <td>
        <p>&nbsp;</p>
        <form action="editparent.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            ...
            <tbody>
              <tr>
                <td colspan="2" bgcolor="#84C1EA">
                  <div align="center">
                    <font color="#FFFFFF">แก้ไขข้อมูลผู้ปกครอง</font>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="203"><input name="pa_name" type="text" id="pa_name" value="<?php echo "$rs[pa_name]"; ?>"></td>
              </tr>
              <tr>
                <td width="221">อาชีพ</td>
                <td width="203"><input name="pa_occupation" type="text" id="pa_occupation" value="<?php echo "$rs[pa_occupation]"; ?>"></td>
              </tr>
              <tr>
                <td width="221">เบอร์โทร</td>
                <td width="203"><input name="pa_tel" type="text" id="pa_tel" value="<?php echo "$rs[pa_tel]"; ?>"></td>
              </tr>
              <tr>
                <td colspan="2">
                  <div align="center">
