...
<body>
  <table style="margin-top: 5%;" width="800" border="1" align="center" bordercolor="#84C1EA" cellpadding="1" cellspacing="0">
    ...
    <tr style="background-color: white;">
      <td>
        <p>&nbsp;</p>
        <form action="editwork.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            ...
            <tbody>
              <tr>
                <td colspan="2" bgcolor="#84C1EA">
                  <div align="center">
                    <font color="#FFFFFF">แก้ไขข้อมูลผลงาน</font>
                  </div>
                </td>
              </tr>
              <tr>
                <td width="221">ชื่อผลงาน</td>
                <td width="203"><input name="w_name" type="text" id="w_name" value="<?php echo "$rs[w_name]"; ?>" />
              ...
              <tr>
                ...
                <td width="203"><input name="w_year" type="text" id="w_year" value="<?php echo "$rs[w_year]"; ?>"></td>
              </tr>
              <tr>
                <td width="221">หน่วยงานที่มอบ</td>
                <td width="203"><input name="w_org" type="text" id="w_org" value="<?php echo "$rs[w_org]"; ?>"></td>
              </tr>
