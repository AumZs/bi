...
<body>
  ...
  <table style="margin-top: 5%;" width="762" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#0000FF">
    ...
    <tr style="background-color: white;">
      <td>
        <form id="form1" name="form1" method="post" action="delpot.php">
          <table width="344" border="1" align="center" cellpadding="5" cellspacing="0">
            <tr>
              <td colspan="2" align="center">ลบตำแหน่ง</td>
            </tr>
            <tr>
              <td width="82">ชื่อตำแหน่ง</td>
              <td width="236"><input name="po_name" type="text" id="po_name" value="<?php echo "$rs[po_name]"; ?>" />
