...
<body>
  <table style="margin-top: 5%;" width="762" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#0000FF">
    ...
    <tr style="background-color: white;">
      <td>
        <form id="form1" name="form1" method="post" action="addpot.php">
          <table width="344" border="1" align="center" cellpadding="5" cellspacing="0">
            <tr>
              <td colspan="2" align="center">เพิ่มตำแหน่ง</td>
            </tr>
            <tr>
              <td width="273">ชื่อตำแหน่ง</td>
              <td width="45"><input type="text" name="po_name" id="po_name" /></td>
            </tr>
            <tr>
