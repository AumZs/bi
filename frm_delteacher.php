...
<body>
  <table style="margin-top: 5%;" width="800" border="1" align="center" bordercolor="#84C1EA" cellpadding="1" cellspacing="0">
    ...
    <tr style="background-color: white;">
      <td>
        <p>&nbsp;</p>
        <form action="delteacher.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            ...
            <tbody>
              <tr>
                <td colspan="2" bgcolor="#84C1EA">
                  <div align="center">
                    <font color="#FFFFFF">ลบข้อมูลอาจารย์</font>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="203"><input name="t_password" type="text" id="t_password" value="<?php echo "$rs[t_password]"; ?>" readonly="readonly"></td>
              </tr>
              <tr>
                <td width="221">ชื่อ-สกุล</td>
                <td width="203"><input name="t_name" type="text" id="t_name" value="<?php echo "$rs[t_name]"; ?>" readonly="readonly"></td>
              </tr>
              <tr>
                <td width="221">ที่อยู่</td>
                <td width="203"><textarea name="t_address" rows="2" readonly="readonly" id="t_address" value="<?php echo "$rs[t_address]"; ?> "><?php echo "$rs[t_address]"; ?></textarea></td>
              </tr>
              <tr>
                <td width="221">เบอร์โทร</td>
                <td width="203"><input name="t_tel" type="text" id="t_tel" value="<?php echo "$rs[t_tel]"; ?>" readonly="readonly"></td>
              </tr>
              <tr>
                <td width="221">รูป</td>
                <td width="203">
